  ...
  return (
    <div className="pt-px flex-none">
      <div className="flex justify-end m-2">
        ...
        <button
          className="bg-[#44475a] text-[#50fa7b] border border-[#50fa7b]  px-3 py-2 rounded mr-2 flex items-center"
        ...
        <button
          className="bg-[#50fa7b] text-[#282a36] px-3 py-2 rounded flex items-center"
          onClick={onRunClick}
        >
